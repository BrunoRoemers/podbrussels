    ...
    return (
      <div className="flex flex-col items-center gap-3 justify-center mb-12 p-6 rounded-2xl bg-primary/5 border-2 border-primary/20">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold text-foreground">This name is available!</span>
        </div>
        <Badge variant="outline" className="text-xl px-6 py-3 font-mono border-primary/30 bg-background">
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="relative">
              ...
              <div className="absolute inset-0 animate-pulse">
                <Heart className="size-12 text-primary/20" fill="currentColor" />
              </div>
            </div>
          ...
          <Card className="border-2 shadow-lg">
            <CardHeader className="text-center pb-6">
              ...
              <CardDescription className="text-lg md:text-xl max-w-2xl mx-auto">
                Every group deserves a memorable web address. Whether you're a neighborhood committee, 
                a volunteer initiative, a community garden, or any collective project—we'll help you 
                get a beautiful name that people will remember.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 hover:border-primary/40 transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    No cost, no hidden fees, no strings attached—just support for your community project
                  </p>
                </div>
                <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 hover:border-primary/40 transition-colors">
                  <div className="p-3 rounded-full bg-primary/10">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Built specifically for groups, collectives, and grassroots initiatives in Brussels
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1 pt-1">
                  <h3 className="font-semibold text-lg mb-2">Choose your name</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Think of a memorable name for your community (e.g., 
                    <span className="font-mono text-primary"> myneighborhood</span>, 
                    <span className="font-mono text-primary"> ourgarden</span>, 
                    <span className="font-mono text-primary"> thecollective</span>). 
                    You'll get <span className="font-mono font-semibold">yourname.pod.brussels</span>.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tell us the name you'd like and share a bit about your project's purpose. 
                    We're real people who care about supporting community initiatives.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1 pt-1">
                  <h3 className="font-semibold text-lg mb-2">We'll set it up</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Once approved, we'll configure your web address and you'll be ready to share 
                    your community's online home with the world.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="what-is-pod">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  A pod is a small group of people, like peas in a pod! We chose this name because 
                  it represents the idea of communities—small groups of people coming together around 
                  shared goals, values, or interests. Just like peas grow together in a pod, your 
              ...
              <AccordionItem value="what-do-i-get">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  You get a memorable web address (like <span className="font-mono text-primary">mycommunity.pod.brussels</span>) 
                  that you can use for your community's website. This makes it easy for people to find and remember 
                  your group online. You'll need to host your website somewhere else (there are many free options), 
                  but we'll make sure your beautiful address points to it.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="who-can-apply">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Anyone organizing a community project, initiative, or group in Brussels! This includes 
                  neighborhood committees, volunteer groups, community gardens, cultural collectives, 
                  mutual aid networks, and any other grassroots initiatives. If you're bringing people 
                  together for a positive purpose, we'd love to help.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="is-it-really-free">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Yes, completely free! There are no costs, no hidden fees, and no strings attached. 
                  We're doing this because we believe in supporting community initiatives in Brussels. 
                  The only thing we ask is that you use it for a genuine community project.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="how-long">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  We're a small team, but we try to respond to all requests within a few days. 
                  Once approved, we'll set up your address as quickly as possible—usually within 
              ...
              <AccordionItem value="what-if-name-taken">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  We'll work with you to find an alternative that works! Sometimes a small variation 
                  (like adding your neighborhood name or a descriptive word) can make your address 
                  even more memorable. We're here to help you find the perfect name for your community.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
            ...
            <CardContent className="pt-12 pb-12">
              <div className="space-y-4 mb-8">
                ...
                <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
                  Claim your memorable web address and give your community a home on the web
                </p>
              </div>
